...
class WaferInfo(models.Model):
    ...
    gross_die = models.IntegerField(verbose_name='粗略数量(Gross die)', default=0, blank=True)
...
class GrainUnitPrice(models.Model):
    ...
    hb_up = models.DecimalField(verbose_name='HB U/P', max_digits=10, decimal_places=3, default=0)
    cp_up = models.DecimalField(verbose_name='CP U/P', max_digits=10, decimal_places=3, default=0)
    rdl_up = models.DecimalField(verbose_name='RDL U/P', max_digits=10, decimal_places=3, default=0)
    bp_up = models.DecimalField(verbose_name='BP U/P', max_digits=10, decimal_places=3, default=0)
    wafer_amt = models.DecimalField(verbose_name='TTL Wafer 加工费', max_digits=10, decimal_places=2, default=0)  # 前段成本之和
    ap_up = models.DecimalField(verbose_name='AP U/P', max_digits=10, decimal_places=3, default=0)
    ap_amt = models.DecimalField(verbose_name='AP AMT', max_digits=10, decimal_places=3, default=0)
    bi_up = models.DecimalField(verbose_name='BI U/P', max_digits=10, decimal_places=3, default=0)
    bi_amt = models.DecimalField(verbose_name='BI AMT', max_digits=10, decimal_places=3, default=0)
    ft1_up = models.DecimalField(verbose_name='FT1 U/P', max_digits=10, decimal_places=3, default=0)
    ft1_amt = models.DecimalField(verbose_name='FT1 AMT', max_digits=10, decimal_places=3, default=0)
    ft2_up = models.DecimalField(verbose_name='FT2 U/P', max_digits=10, decimal_places=3, default=0)
    ft2_amt = models.DecimalField(verbose_name='FT2 AMT', max_digits=10, decimal_places=3, default=0)
    ft3_up = models.DecimalField(verbose_name='FT3 U/P', max_digits=10, decimal_places=3, default=0)
    ft3_amt = models.DecimalField(verbose_name='FT3 AMT', max_digits=10, decimal_places=3, default=0)
    ft4_up = models.DecimalField(verbose_name='FT4 U/P', max_digits=10, decimal_places=3, default=0)
    ft4_amt = models.DecimalField(verbose_name='FT4 AMT', max_digits=10, decimal_places=3, default=0)
    ft5_up = models.DecimalField(verbose_name='FT5 U/P', max_digits=10, decimal_places=3, default=0)
    ft5_amt = models.DecimalField(verbose_name='FT5 AMT', max_digits=10, decimal_places=3, default=0)
    ft6_up = models.DecimalField(verbose_name='FT6 U/P', max_digits=10, decimal_places=3, default=0)
    ft6_amt = models.DecimalField(verbose_name='FT6 AMT', max_digits=10, decimal_places=3, default=0)
    msp_up = models.DecimalField(verbose_name='MSP U/P', max_digits=10, decimal_places=3, default=0)
    msp_amt = models.DecimalField(verbose_name='MSP AMT', max_digits=10, decimal_places=3, default=0)
