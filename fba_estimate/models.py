...
class EstimateMonthDetail(models.Model):
    ...
    second_service = models.ForeignKey(SecondService, verbose_name='二级业务', on_delete=models.SET_NULL, null=True, blank=True)
    region = models.IntegerField(verbose_name='区域', choices=region_types, null=True, blank=True)
    in_company = models.CharField(verbose_name='收款公司', max_length=100, null=True, blank=True)
