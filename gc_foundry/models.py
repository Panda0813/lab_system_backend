...
class FoundryEquipment(models.Model):
    ...
    purchase_order_no = models.CharField(verbose_name='采购订单编号', max_length=100)
    ...
    price = models.DecimalField(verbose_name='原币单价', max_digits=10, decimal_places=2, null=True)
    currency = models.ForeignKey(Currency, on_delete=models.SET_NULL, verbose_name='币种', null=True)
    total_amount = models.DecimalField(verbose_name='原币总价', max_digits=10, decimal_places=2, null=True)
    base_total_amount = models.DecimalField(verbose_name='本位币总价', max_digits=10, decimal_places=2, null=True)
